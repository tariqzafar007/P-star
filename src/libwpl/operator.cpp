...
OP_DEF(OP_INC_SUFFIX,	"++", 2, WPL_OP_F_LEFT_ONE|WPL_OP_F_MODIFIES, 2)
OP_DEF(OP_DEC_SUFFIX,	"--", 2, WPL_OP_F_LEFT_ONE|WPL_OP_F_MODIFIES, 2)
OP_DEF(OP_INC_PREFIX,	"++", 3, WPL_OP_F_RIGHT_ONE|WPL_OP_F_MODIFIES, 2)
OP_DEF(OP_DEC_PREFIX,	"--", 3, WPL_OP_F_RIGHT_ONE|WPL_OP_F_MODIFIES, 2)
...
OP_DEF(OP_SAVE_DISCARD,	"=>", 15, WPL_OP_F_RIGHT_ONE|WPL_OP_F_MODIFIES, 2)

OP_DEF(OP_ASSIGN,		"=",   16, WPL_OP_F_RIGHT_BOTH|WPL_OP_F_MODIFIES, 1)
OP_DEF(OP_ASSIGN_SUM,		"+=",  16, WPL_OP_F_RIGHT_BOTH|WPL_OP_F_MODIFIES, 2)
OP_DEF(OP_ASSIGN_SUB,		"-=",  16, WPL_OP_F_RIGHT_BOTH|WPL_OP_F_MODIFIES, 2)
OP_DEF(OP_ASSIGN_MUL,		"*=",  16, WPL_OP_F_RIGHT_BOTH|WPL_OP_F_MODIFIES, 2)
OP_DEF(OP_ASSIGN_DIV,		"/=",  16, WPL_OP_F_RIGHT_BOTH|WPL_OP_F_MODIFIES, 2)
OP_DEF(OP_ASSIGN_MOD,		"%=",  16, WPL_OP_F_RIGHT_BOTH|WPL_OP_F_MODIFIES, 2)
OP_DEF(OP_ASSIGN_AND,		"&=",  16, WPL_OP_F_RIGHT_BOTH|WPL_OP_F_MODIFIES, 2)
OP_DEF(OP_ASSIGN_XOR,		"^=",  16, WPL_OP_F_RIGHT_BOTH|WPL_OP_F_MODIFIES, 2)
OP_DEF(OP_ASSIGN_OR,		"|=",  16, WPL_OP_F_RIGHT_BOTH|WPL_OP_F_MODIFIES, 2)
OP_DEF(OP_ASSIGN_SH_LEFT,	"<<=", 16, WPL_OP_F_RIGHT_BOTH|WPL_OP_F_MODIFIES, 3)
OP_DEF(OP_ASSIGN_SH_RIGHT,	">>=", 16, WPL_OP_F_RIGHT_BOTH|WPL_OP_F_MODIFIES, 3)
OP_DEF(OP_ASSIGN_CONCAT,	".=",  16, WPL_OP_F_RIGHT_BOTH|WPL_OP_F_MODIFIES, 2)
